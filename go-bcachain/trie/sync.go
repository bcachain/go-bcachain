...
type Sync struct {
	database bcacdb.Reader             // Persistent database to check for existing entries
...
func NewSync(root common.Hash, database bcacdb.Reader, callback LeafCallback) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) Commit(dbw bcacdb.Writer) (int, error) {
