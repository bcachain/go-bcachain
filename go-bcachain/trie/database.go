...
type Database struct {
	diskdb bcacdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb bcacdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb bcacdb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() bcacdb.Reader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch bcacdb.Batch) error {
