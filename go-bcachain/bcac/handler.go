...
import (
	...
	"github.com/bcachain/go-bcachain/bcac/fetcher"
...
func NewProtocolManager(config *params.ChainConfig, mode downloader.SyncMode, networkID uint64, mux *event.TypeMux, txpool txPool, engine consensus.Engine, blockchain *core.BlockChain, chaindb bcacdb.Database, whitelist map[uint64]common.Hash) (*ProtocolManager, error) {
