...
type BloomIndexer struct {
	...
	db      bcacdb.Database       // database instance to write index data and metadata into
...
func NewBloomIndexer(db bcacdb.Database, size, confirms uint64) *core.ChainIndexer {
