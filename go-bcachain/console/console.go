...
import (
	...
	"github.com/bcachain/go-bcachain/internal/jsre"
	"github.com/bcachain/go-bcachain/internal/web3ext"
...
// Welcome show summary of current BCAChain instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Geth metadata
	fmt.Fprintf(c.printer, "Welcome to the BCAChain JavaScript console!\n\n")
	c.jsre.Run(`
