...
import (
	...
	"github.com/bcachain/go-bcachain/accounts/abi/bind"
	"github.com/bcachain/go-bcachain/bcacclient"
	"github.com/bcachain/go-bcachain/common"
	"github.com/bcachain/go-bcachain/contracts/chequebook"
	"github.com/bcachain/go-bcachain/contracts/ens"
	"github.com/bcachain/go-bcachain/metrics"
	"github.com/bcachain/go-bcachain/p2p"
	"github.com/bcachain/go-bcachain/p2p/enode"
	"github.com/bcachain/go-bcachain/p2p/protocols"
	"github.com/bcachain/go-bcachain/params"
	"github.com/bcachain/go-bcachain/rpc"
	"github.com/bcachain/go-bcachain/swarm/api"
	httpapi "github.com/bcachain/go-bcachain/swarm/api/http"
	"github.com/bcachain/go-bcachain/swarm/fuse"
	"github.com/bcachain/go-bcachain/swarm/log"
	"github.com/bcachain/go-bcachain/swarm/network"
	"github.com/bcachain/go-bcachain/swarm/network/stream"
	"github.com/bcachain/go-bcachain/swarm/pss"
	"github.com/bcachain/go-bcachain/swarm/state"
	"github.com/bcachain/go-bcachain/swarm/storage"
	"github.com/bcachain/go-bcachain/swarm/storage/feed"
	"github.com/bcachain/go-bcachain/swarm/storage/mock"
	"github.com/bcachain/go-bcachain/swarm/swap"
	"github.com/bcachain/go-bcachain/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	if config.SwapAPI != "" && config.SwapEnabled {
		...
		backend, err = bcacclient.Dial(config.SwapAPI)
		if err != nil {
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config, privkey *ecdsa.PrivateKey) (*ensClient, error) {
	...
	ethClient := bcacclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := bcacclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
