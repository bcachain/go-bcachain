...
//
// https://github.com/bcachain/go-bcachain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/bcachain/go-bcachain/wiki/Management-APIs#personal_ecRecover
...
func (api *PublicDebugAPI) TestSignPoBCBlock(ctx context.Context, address common.Address, number uint64) (common.Address, error) {
	block, _ := api.b.BlockByNumber(ctx, rpc.BlockNumber(number))
	if block == nil {
	...
	sealHash := pobc.SealHash(header).Bytes()
	log.Info("test signing of pobc block",
