...
import (
	...
	rpc "github.com/bcachain/go-bcachain/rpc"
)
...
func New(ctx *node.ServiceContext, config *bcac.Config) (*LightEthereum, error) {
	...
	leth := &LightEthereum{
		...
		engine:         bcac.CreateConsensusEngine(ctx, chainConfig, &config.Ethash, nil, false, chainDb),
		shutdownChan:   make(chan bool),
		networkId:      config.NetworkId,
		bloomRequests:  make(chan chan *bloombits.Retrieval),
		bloomIndexer:   bcac.NewBloomIndexer(chainDb, params.BloomBitsBlocksClient, params.HelperTrieConfirmations),
	}
