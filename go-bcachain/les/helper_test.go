...
import (
	...
	"github.com/bcachain/go-bcachain/les/flowcontrol"
...
func testIndexers(db bcacdb.Database, odr light.OdrBackend, iConfig *light.IndexerConfig) (*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer) {
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db bcacdb.Database, ulcConfig *eth.ULCConfig) (*ProtocolManager, error) {
	var (
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db bcacdb.Database, ulcConfig *eth.ULCConfig) *ProtocolManager {
