...
import (
	...
	"github.com/bcachain/go-bcachain/trie"
)
...
type testOdr struct {
	...
	sdb, ldb      bcacdb.Database
	disable       bool
}

func (odr *testOdr) Database() bcacdb.Database {
	return odr.ldb
}
...
type odrTestFn func(ctx context.Context, db bcacdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error)

func TestOdrGetBlockLes1(t *testing.T) { testChainOdr(t, 1, odrGetBlock) }

func odrGetBlock(ctx context.Context, db bcacdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrGetReceipts(ctx context.Context, db bcacdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrAccounts(ctx context.Context, db bcacdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
...
func odrContractCall(ctx context.Context, db bcacdb.Database, bc *core.BlockChain, lc *LightChain, bhash common.Hash) ([]byte, error) {
