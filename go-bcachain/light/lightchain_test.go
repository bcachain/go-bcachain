...
func makeHeaderChain(parent *types.Header, n int, db bcacdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (bcacdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() bcacdb.Database {
	return odr.db
}
