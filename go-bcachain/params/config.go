...
var (
	...
	MainnetGenesisHash = common.HexToHash("0xf7b55e9c0ca7bb59233a7ed2be1ef8bcf19b6dc3307ba28b067c5afb45ec50b9")

	// BCAChain Mars Test Net hash
	TestnetGenesisHash = common.HexToHash("0x4c89029345d95f9a1b99ce4e592d8468510c930ff9187e115d0b71e0145ed299")
...
var (
	...
	// AllPoBCProtocolChanges contains every protocol change (EIPs) introduced
	// and accepted by the Ethereum core developers into the pobc consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	PoBC *PoBCConfig `json:"clique,omitempty"`
}
...
// PoBCConfig is the consensus engine configs for proof-of-authority based sealing.
type PoBCConfig struct {
	Period uint64 `json:"period"` // Number of seconds between blocks to enforce
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint
}
...
// String implements the stringer interface, returning the consensus engine details.
func (c *PoBCConfig) String() string {
	return "pobc"
}
