...
func NewHeaderChain(chainDb bcacdb.Database, config *params.ChainConfig, engine consensus.Engine, procInterrupt func() bool) (*HeaderChain, error) {
...
type DeleteCallback func(bcacdb.Deleter, common.Hash, uint64)
