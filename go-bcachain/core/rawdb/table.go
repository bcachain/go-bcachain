...
func NewTable(db bcacdb.Database, prefix string) bcacdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() bcacdb.Iterator {
	return t.NewIteratorWithPrefix(nil)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) bcacdb.Iterator {
...
func (t *table) NewBatch() bcacdb.Batch {
