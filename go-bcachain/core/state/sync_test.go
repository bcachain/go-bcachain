...
// account array.
func checkStateAccounts(t *testing.T, db bcacdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bcacdb.Database, root common.Hash) error {
...
func checkStateConsistency(db bcacdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(bcacdb.Database), srcRoot)
